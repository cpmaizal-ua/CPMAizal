...
def banner(console):
    ...
    console.print("[bold green]♕ Car Parking Multiplayer 2 Tool CPMBaloch AND CPMAmer [/bold green]: Get In Touch With Me To Buy An Unlimitied Balance.")
...
if __name__ == "__main__":
    ...
    while True:
        ...
        while True:
            ...
            console.print("[bold][cyan](03):[/cyan] [green]Increase Money ~ 1[/green]")
            console.print("[bold][cyan](04):[/cyan] [green]Change ID ~ 2[/green]")
            console.print("[bold][cyan](05):[/cyan] [green]Change Name ~ 1K[/green]")
            console.print("[bold][cyan](06):[/cyan] [green]Complete Missions ~ 5[/green]")
            console.print("[bold][cyan](07):[/cyan] [green]Delete Friends ~ 10[/green]")
            console.print("[bold][cyan](08):[/cyan] [green]King Rank ~ 9[/green]")
            console.print("[bold][cyan](09):[/cyan] [green]Maximize Drag Wins ~ 8[/green]")
            console.print("[bold][cyan](10):[/cyan] [green]Unlock Slots ~ Free[/green]")
            console.print("[bold][cyan](11):[/cyan] [green]Unlock Apartments ~ 5[/green]")
            console.print("[bold][cyan](12):[/cyan] [green]Unlock Brakes ~ 5[/green]")
            console.print("[bold][cyan](13):[/cyan] [green]Unlock Wheels ~ 6[/green]")
            console.print("[bold][cyan](14):[/cyan] [green]Unlock Clothes ~ 9[/green]")
            console.print("[bold][cyan](15):[/cyan] [green]Unlock Cars ~ 10[/green]")
