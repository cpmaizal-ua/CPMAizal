...
def load_player_data(cpm):
    ...
    if response.get('ok'):
        ...
        if 'Money' in WalletData and 'LocalID' in PlayerStorage and 'Brakes' in PlayerStorage:
            ...
            console.print(f"[bold red]Name   [/bold green]: { (PlayerStorage.get('Name') if 'Name' in PlayerStorage else 'UNDEFINED') }.")
            console.print(f"[bold green]ID     [/bold green]: { (PlayerStorage.get('LocalID') if 'LocalID' in PlayerStorage else 'UNDEFINED') }.")
            console.print(f"[bold yellow]Money  [/bold green]: { (WalletData.get('Money') if 'Money' in WalletData else 'UNDEFINED') }.")
            console.print(f"[bold purple]Coins  [/bold green]: { (WalletData.get('Coins') if 'Coins' in WalletData else 'UNDEFINED') }.")
        else:
            console.print("[bold blue]! ERROR[/bold red]: new accounts most be signed-in to the game at least once !.")
            exit(1)
    else:
...
def load_key_data(cpm):
    ...
    console.print(f"[bold pink]Access Key [/bold pink]: { data.get('access_key') }.")
    console.print(f"[bold pink]Telegram ID[/bold pink]: { data.get('telegram_id') }.")
    console.print(f"[bold pink]Balance    [/bold pink]: { (data.get('coins') if not data.get('is_unlimited') else 'Unlimited') }.")

def load_client_details():
    response = requests.get("http://ip-api.com/json")
    data = response.json()
    console.print("[bold][red]==================================================[/red][/bold]")
    console.print(f"[bold][white]Location[/bold][/white]: {data.get('city')}, {data.get('regionName')}, {data.get('countryCode')}")
    console.print(f"[bold][white]ISP[/bold][/white]     : {data.get('isp')}")
...
if __name__ == "__main__":
    ...
    while True:
        ...
        while True:
            ...
            console.print("[bold][blue](01):[/blue] [green]Account Delete ~ FREE[/green]")
            console.print("[bold][blue](02):[/blue] [green]Account Register ~ FREE[/green]")
            console.print("[bold][blue](03):[/blue] [green]Increase Money ~ 4K[/green]")
            console.print("[bold][blue](04):[/blue] [green]Change ID ~ 2.5K[/green]")
            console.print("[bold][blue](05):[/blue] [green]Change Name ~ 1K[/green]")
            console.print("[bold][blue](06):[/blue] [green]Complete Missions ~ 6K[/green]")
            console.print("[bold][blue](07):[/blue] [green]Delete Friends ~ 2K[/green]")
            console.print("[bold][blue](08):[/blue] [green]King Rank ~ 6K[/green]")
            console.print("[bold][blue](09):[/blue] [green]Maximize Drag Wins ~ 6K[/green]")
            console.print("[bold][blue](10):[/blue] [green]Unlock Slots ~ 7K[/green]")
            console.print("[bold][blue](11):[/blue] [green]Unlock Apartments ~ 10K[/green]")
            console.print("[bold][blue](12):[/blue] [green]Unlock Brakes ~ 5K[/green]")
            console.print("[bold][blue](13):[/blue] [green]Unlock Wheels ~ 6K[/green]")
            console.print("[bold][blue](14):[/blue] [green]Unlock Clothes ~ 9K[/green]")
            console.print("[bold][blue](15):[/blue] [green]Unlock Cars ~ 10K[/green]")
            console.print("[bold][blue](0) :[/blue] [red]Exit[/red]", end="\n\n")
