...
def banner(console):
    ...
    brand_name = figlet_format('CPMAizal2', font='drpepper')
    colors = [
    ...
    console.print("[bold green]♕ AizalCPM2[/bold green]: Car Parking Multiplayer 2 Hacking Tool.")
...
if __name__ == "__main__":
    ...
    while True:
        ...
        while True:
            ...
            console.print("[bold][cyan](03):[/cyan] [green]Increase Money ~ 400[/green]")
            console.print("[bold][cyan](04):[/cyan] [green]Change ID ~ 500[/green]")
            console.print("[bold][cyan](05):[/cyan] [green]Change Name ~ 1K[/green]")
            console.print("[bold][cyan](06):[/cyan] [green]Complete Missions ~ 1000[/green]")
            console.print("[bold][cyan](07):[/cyan] [green]Delete Friends ~ 2K[/green]")
            console.print("[bold][cyan](08):[/cyan] [green]King Rank ~ 800[/green]")
            console.print("[bold][cyan](09):[/cyan] [green]Maximize Drag Wins ~ 300[/green]")
            console.print("[bold][cyan](10):[/cyan] [green]Unlock Slots ~ 700[/green]")
            console.print("[bold][cyan](11):[/cyan] [green]Unlock Apartments ~ 100[/green]")
