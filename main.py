...
def banner(console):
    ...
    console.print("[bold green]♕ CPMAizal is the owner of this tool telegram @ItzAizal[/bold green]: Car Parking Multiplayer 2 Hacking Tool And Get In touch with me to buy an unlimitied balance.")
