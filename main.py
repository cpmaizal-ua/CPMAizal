...
def banner(console):
    ...
    console.print("[bold green]♕ CPMGala[/bold green]: Автотұрақ көп ойыншы құралы.")
    ...
    console.print("[bold yellow]! Note[/bold yellow]: Бұл құралды пайдаланбас бұрын CPM жүйесінен шығыңыз !.", end="\n\n")
