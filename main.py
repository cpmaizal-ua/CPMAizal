...
from cpmmohammad import CPMMohammad
...
def banner(console):
    ...
    brand_name = figlet_format('Mohammad2', font='drpepper')
    colors = [
    ...
    console.print("[bold green]♕  CPMMohammad [/bold green]: Car Parking Multiplayer 2 Hacking Tool.")
